...
from .overworld import OverworldPresenter, ROAMER_OFFSET, ROAMER_SIZE
...
class EmeraldAdapter:
    ...
    def _snapshot(
        ...
        if len(event_flags) != FLAGS_SIZE or len(rematches) != REMATCHES_SIZE:
